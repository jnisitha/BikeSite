...
mongoose.connect('mongodb://127.0.0.1:27017/mymongodb', {useNewUrlParser: true});//intially creates the DB and subsequently connects to it. mongoose.connect('mongodb://localhost:27017/myapp');
